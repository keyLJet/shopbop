...
//用于返回首页数据
let goodsList = require('./data/goodsList.json');
router.get('/goodsList',function(ctx,next){
	console.log('goodsList')
    ctx.body=goodsList
})
let likeGood = require('./data/likeGood.json');
router.get('/likeGood',function(ctx,next){
	console.log('likeGood')
    ctx.body=likeGood
})
